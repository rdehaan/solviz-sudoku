...
ace.define("ace/mode/gringo_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var GringoHighlightRules = function() {
    this.$rules = { start:
      ...
      '#lua':
      [ { token: ["keyword.control", 'punctuation.separator', 'entity.name', 'punctuation.separator'],
      ...
      [ { token: 'keyword.control',
          regex: '#include\\b|#show\\b|#program\\b|#const\\b|#sum\\+|#sum\\b|#count\\b|#minimize\\b|#maximize\\b|#true\\b|#false\\b|#theory\\b|#heuristic\\b'
        },
      ],
      '#operator':
...
ace.define("ace/mode/gringo",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/gringo_highlight_rules","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var GringoHighlightRules = require("./gringo_highlight_rules").GringoHighlightRules;
